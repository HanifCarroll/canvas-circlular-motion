...
function () {
  ...
  _createClass(Particle, [{
    ...
    value: function draw(lastPoint) {
      ...
      _utils.c.lineWidth = this.radius;

      _utils.c.moveTo(lastPoint.x, lastPoint.y);

      _utils.c.lineTo(this.x, this.y);
    ...
    value: function update() {
      ...
      this.radians += this.velocity; // Trail effect
...
function init() {
  ...
  for (var i = 0; i < 50; i++) {
    ...
    var x = _utils.canvas.width / 2;
    var y = _utils.canvas.height / 2;
...
function animate() {
  ...
  _utils.c.fillStyle = "rgba(255, 255, 255, 0.05";

  _utils.c.fillRect(0, 0, _utils.canvas.width, _utils.canvas.height);
